...
Now make a plot that shows the proportions of these rating_diff_type for each machine and contingency condition; as error bars, show 95% Propotion CIs (using binom.confint from the binom package)
